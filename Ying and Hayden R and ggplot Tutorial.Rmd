...
* **Effect size** - magnitude of the difference between groups. The absolute effect size is the difference between the average, or mean, values in two different groups. Standardized effect size can be used to compared among studies. Larger effects, larger power. 
