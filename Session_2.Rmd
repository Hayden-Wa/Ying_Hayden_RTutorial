...
We are glad you have lived through our [first 3 sections](https://htmlpreview.github.io/?https://github.com/YingChen94/BnR_Hayden_Ying_R_Session/blob/master/R_Hayden_Ying_20200429.html))! 
...
- Dichotomy can be misleading. 
    ...
    + One study is "statistically significant" while the other is "not statistically significant". 
    ![<font size="4" color="gray">*Screenshot from Amrhein et al. 2019.*</font>](IMG306.png){width=800px}
...
- **Akaike information criterion**: 
    + Relative test of model quality
- **Estimation statistics**: effect size + confidence interval 
    ...
    + One exmple from *Gardner, M. J., and D. G. Altman. 1986. British Medical Journal 292(6522): 746-750.*
    + ![<font size="4" color="gray">*Screenshot from Gardner and Altman 1986.*</font>](IMG305.png){width=600px}
    + Another example made in R. 
...
It is generally used in **meta-analysis** (for combining and comparing estimates from different studies). 

**Manual coding**

Go find the equation. 

For examle, the most simple one is the standardised mean difference between the two
groups. 

Effect size = $\frac{\bar{x_A}-\bar{x_B}}{\sigma}$. Simply use the function `mean()` `sd()`. 
...
<p>&nbsp;</p>
#### 4.3 Confidence interval - Bootstrapping 
...
```{r}
# read our dataset 
dat <- read.csv("FrogPandemic.csv", header=T)
dat <- dat[,-1]
