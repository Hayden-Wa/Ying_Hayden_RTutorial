...
- **Akaike information criterion**: 
    + Relative test of model quality. Use `AIC()`
...
<p>&nbsp;</p>
**Example 2. ANOVA for factors with Ordered Levels** 
...
plot(shared.control_10loc, color.column = species, rawplot.type = "swarmplot") 
# Much smaller confidence interval if we have larger sample size 
...
<p>&nbsp;</p>
**Example 3. Confidence interval for regression** 

Unfortunately, no plot is available in dabestr for regression analysis. But we can still bootstrap the regression coeficient. 

Null hypothesis: frog mortality does not correlate with number of cars on the road in Ontario (r=0). 

```{r}
# step 1. Caculate regression coefficient r 
