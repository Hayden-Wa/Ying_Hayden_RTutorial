...
# Ying's codes 
# a pool to draw mean mortality rate and mean number of car per hour 
mor_mean_pool <- rnorm(n=10, mean=25, sd=1)
car_mean_pool <- rnorm(n=10, mean=50, sd=1)
...
loc_all <- c("Site A", "Site B", "Site B")
...
# Assign cars to frog mortality in a dataset
  ...
  dat$species <- c("Rana clamitans", "Pseudacris crucifer", "Lithobates pipiens") # add species to the dataset 
